...
## load pred values
load(file = 'results/tvalues_croppers.Rdata')
load(file = 'results/tvalues_scrapers.Rdata')
...
## output for Rmd
print(plot_grid(left, mid, right, nrow=1, labels=c('', '', ''), label_size=0))

## save
# pdf(file = 'figures/Figure3.pdf', height = 6, width = 12)
